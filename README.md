...
Activation order must be: kalman_controller then broyden_controller & rigid_pose_broadcaster(downstream consumer loads first and the upstream providers connect after it).
